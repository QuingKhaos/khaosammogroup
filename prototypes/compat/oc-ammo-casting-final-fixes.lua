...
if mods["OCs_ammo_casting"] then
  ...
  if settings.startup["heavy-artillery-shells"].value then
    lib.update_subgroup("ammo", "heavy-artillery-shell", "ammo-artillery-shell")
    lib.update_recipe_subgroup("heavy-artillery-shell-upgrading", "ammo-artillery-shell")
    lib.update_recipe_subgroup("oc-casting-heavy-artillery-shell", "ammo-artillery-shell")
  end
